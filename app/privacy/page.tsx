    ...
    <>
      ...
      >
          ...
          <div className="prose-block">
            ...
            <h2 id="privacy-section-1" className="page-section-anchor text-2xl font-headline font-normal text-on-surface mt-6">1. Introduction</h2>
            <p>
            ...
            <h2 id="privacy-section-2" className="page-section-anchor text-2xl font-headline font-normal text-on-surface mt-6">2. Personal data we collect</h2>
            <p>
            ...
            <h2 id="privacy-section-3" className="page-section-anchor text-2xl font-headline font-normal text-on-surface mt-6">3. How we use personal data</h2>
            ...
            <h2 id="privacy-section-4" className="page-section-anchor text-2xl font-headline font-normal text-on-surface mt-6">4. Disclosure of personal data</h2>
            <p>
            ...
            <h2 id="privacy-section-5" className="page-section-anchor text-2xl font-headline font-normal text-on-surface mt-6">5. Consent and withdrawal</h2>
            <p>
            ...
            <h2 id="privacy-section-6" className="page-section-anchor text-2xl font-headline font-normal text-on-surface mt-6">6. Access and correction</h2>
            <p>
            ...
            <h2 id="privacy-section-7" className="page-section-anchor text-2xl font-headline font-normal text-on-surface mt-6">7. Retention</h2>
            <p>
            ...
            <h2 id="privacy-section-8" className="page-section-anchor text-2xl font-headline font-normal text-on-surface mt-6">8. Protection of personal data</h2>
            <p>
            ...
            <h2 id="privacy-section-9" className="page-section-anchor text-2xl font-headline font-normal text-on-surface mt-6">9. Cookies and website analytics</h2>
            <p>
            ...
            <h2 id="privacy-section-10" className="page-section-anchor text-2xl font-headline font-normal text-on-surface mt-6">10. Children</h2>
            <p>
            ...
            <h2 id="privacy-section-11" className="page-section-anchor text-2xl font-headline font-normal text-on-surface mt-6">11. International transfers</h2>
            <p>
            ...
            <h2 id="privacy-section-12" className="page-section-anchor text-2xl font-headline font-normal text-on-surface mt-6">12. Updates to this policy</h2>
            <p>
            ...
            <h2 id="privacy-section-13" className="page-section-anchor text-2xl font-headline font-normal text-on-surface mt-6">13. Data Protection Officer</h2>
            <p>
