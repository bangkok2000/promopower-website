    ...
    <footer className="w-full bg-charcoal-dark border-t border-white/5 px-6 sm:px-12 xl:px-24 py-10 sm:py-14">
      <div className="flex flex-col md:flex-row justify-between items-start gap-10 sm:gap-12 max-w-7xl mx-auto">
        <div className="max-w-sm">
          ...
          <p className="font-body text-sm leading-relaxed text-on-surface-variant/60 mb-8 mt-2">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-8 sm:gap-12 flex-1 md:justify-items-end">
          ...
          <div className="space-y-4">
            ...
            <div className="flex gap-4">
              ...
              <a
                href="https://www.instagram.com/promopowersg/"
                target="_blank"
                rel="noopener noreferrer"
                className="w-10 h-10 rounded-full bg-white/5 flex items-center justify-center hover:bg-primary transition-all cursor-pointer text-white hover:text-charcoal-dark"
              ...
              <a
                href="https://www.facebook.com/PromoPower.com.sg"
                target="_blank"
                rel="noopener noreferrer"
                className="w-10 h-10 rounded-full bg-white/5 flex items-center justify-center hover:bg-primary transition-all cursor-pointer text-white hover:text-charcoal-dark"
                aria-label="Facebook"
